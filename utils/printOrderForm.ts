...
export function openPrintOrderForm(
    request: ApprovalRequest,
    rows: PrintRowContext[],
    ...
    rows.forEach((ctx, idx) => {
        ...
        const ltMonths = ctx.effectiveLT ? (ctx.effectiveLT / 30).toFixed(1) : '-';
