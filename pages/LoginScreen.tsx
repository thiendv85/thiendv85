...
export const LoginScreen = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Nếu thành công, AuthProvider sẽ update session → App.tsx render app
    };
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-500/20 border border-blue-400/30 mb-4 backdrop-blur-sm">
                        <i className="fas fa-boxes-stacked text-blue-400 text-2xl"></i>
                    </div>
                    <Typography variant="h1" className="text-white !text-3xl tracking-tight">ATP System</Typography>
                    <Typography variant="body" className="text-slate-400 mt-1">Inventory Intelligence Platform</Typography>
                </div>

                {/* Card */}
                <div className="bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
                    <Typography variant="h2" className="text-white mb-6 text-center">Đăng nhập</Typography>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        >
                            {isLoading ? (
                                <><i className="fas fa-circle-notch fa-spin"></i> Đang đăng nhập...</>
                            ) : (
                                <><i className="fas fa-arrow-right-to-bracket"></i> Đăng nhập</>
                            )}
                        </button>
                    </form>
                </div>
